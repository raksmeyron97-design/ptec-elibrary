...
export default function DownloadsChart({ data }: { data: DailyPoint[] }) {
      ...
      <svg width={width} height={height} className="block overflow-visible">
        <defs>
          <linearGradient id="dlFill" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%"   stopColor={FILL_COLOR} stopOpacity={0.42} />
            <stop offset="45%"  stopColor={FILL_COLOR} stopOpacity={0.12} />
            <stop offset="100%" stopColor={FILL_COLOR} stopOpacity={0} />
          </linearGradient>
          <filter id="dlDotGlow" x="-80%" y="-80%" width="260%" height="260%">
        ...
        {areaPath && (
          <path
            ...
            style={
              reducedMotion
                ? undefined
                : { opacity: 0, animation: "dlFadeIn 0.9s ease-out 0.5s forwards" }
            }
          />
        )}
        ...
        <path
          ...
          style={
            reducedMotion
              ...
              : {
                  strokeDasharray: 1,
                  animation: "dlDraw 1.4s cubic-bezier(0.4,0,0.2,1) forwards",
                }
          }
        />
