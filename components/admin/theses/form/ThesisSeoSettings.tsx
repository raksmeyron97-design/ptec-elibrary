...
export default function ThesisSeoSettings({
  seoTitle, seoDescription, ogImage,
  onSeoTitleChange, onSeoDescriptionChange, onOgImageChange,
  fallbackTitle, fallbackDescription, fallbackImage,
  siteUrl, slug, disabled,
}: {
  seoTitle: string;
  ...
  const previewTitle = seoTitle || fallbackTitle || "Untitled thesis";
    ...
    <div className="space-y-4 rounded-xl border border-divider bg-bg-surface p-5 shadow-sm">
      ...
      <label className="block">
        ...
        <textarea
          ...
          disabled={disabled}
          placeholder={fallbackDescription || "Short description shown in search results (defaults to an abstract excerpt)"}
          maxLength={200}
