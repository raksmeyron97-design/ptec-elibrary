    ...
    <div className="rounded-xl border border-divider bg-bg-surface p-2.5 shadow-sm">
      <div className="flex flex-col gap-2.5 lg:flex-row lg:items-center">
        ...
        <div className="flex flex-1 items-center gap-2 rounded-lg border border-divider bg-paper px-3">
          ...
          <label htmlFor="perm-search" className="sr-only">Search features</label>
          <input
            id="perm-search"
            type="text"
            value={query}
          ...
          />
          {query && (
            <button type="button" onClick={() => onQuery("")} aria-label="Clear search" className="text-text-muted hover:text-text-body">
              <X className="h-4 w-4" />
            </button>
          )}
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="relative flex items-center">
            ...
            <label htmlFor="perm-category" className="sr-only">Category</label>
            <select
              id="perm-category"
              value={category}
          ...
          <div className="relative flex items-center">
            <label htmlFor="perm-role" className="sr-only">Role</label>
            <select
              id="perm-role"
              value={roleFilter}
