...
export function FilterSelect({
  ...
  return (
    <select
      ...
      className="appearance-none cursor-pointer bg-paper text-text-muted border border-divider rounded-full px-3 py-[7px] text-base font-medium transition-all sm:text-[12px] hover:border-brand/30 hover:bg-brand/5 hover:text-brand focus:outline-none focus:ring-2 focus:ring-brand/20"
    >
