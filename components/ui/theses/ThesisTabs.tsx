  ...
  return (
    <div id="thesis-tabs" className="scroll-mt-4 rounded-2xl border border-divider bg-bg-surface shadow-sm">
      ...
      <div
        ...
        className="sticky top-[calc(var(--ptec-sticky-top)+1rem)] z-10 flex gap-0.5 overflow-x-auto rounded-t-2xl border-b border-divider bg-bg-app/80 px-2 backdrop-blur-sm max-lg:bg-bg-app max-lg:backdrop-blur-none sm:px-3"
      >
        {tabs.map((t) => {
