/**
 * Client-safe URL query-param helpers for the Manage E-books page (no
 * "server-only" import, unlike lib/admin/ebooks.ts, since this runs in the
...
export const EBOOKS_BASE_PATH = "/admin/manage";
