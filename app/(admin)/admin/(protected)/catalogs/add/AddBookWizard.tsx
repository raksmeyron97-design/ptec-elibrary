...
export default function AddBookWizard({ categories }: { categories: string[] }) {
    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <h1 className="text-2xl font-bold text-[#0a1629]">Add Physical Copies</h1>
          ...
          <div className="mt-2 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-1.5 shadow-sm">
            ...
            <span className="text-xs font-semibold text-slate-700">{book.title}</span>
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Form */}
      <form action={handleAddBook} className="rounded-2xl bg-white border border-slate-100 shadow-sm p-6 space-y-5">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            <p className="mt-1 text-[10px] text-slate-400">Default location — can be overridden per copy</p>
          </div>
        ...
        <div className="flex items-center justify-end gap-3 pt-2">
          ...
          <button
            type="submit"
            disabled={loading}
            className="rounded-xl bg-gradient-to-br from-[#0a1629] to-[#007c91] px-8 py-2.5 text-sm font-semibold text-white shadow-[0_4px_16px_rgba(0,124,145,0.3)] transition hover:shadow-[0_6px_24px_rgba(0,124,145,0.45)] active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
          >
