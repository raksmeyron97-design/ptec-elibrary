...
import { ArrowLeft, ShieldCheck, SearchX } from "lucide-react";
...
const BASE_PATH = "/admin/manage/duplicates";
  ...
  return (
    <div className="w-full space-y-6">
      <div>
        <Link
          href="/admin/manage"
          className="focus-field mb-2 inline-flex items-center gap-1.5 rounded text-sm font-medium text-text-muted transition hover:text-brand"
        >
