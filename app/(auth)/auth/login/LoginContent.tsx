...
export default function LoginContent({ stats, site }: Props) {
        ...
        <div className="w-full max-w-[420px]">
          ...
          <form onSubmit={handleLogin} noValidate className="space-y-4">
            ...
            <div>
              ...
              />
              {emailErrMsg && (
                <p id="login-email-error" role="alert" className="mt-1.5 text-xs text-red-500">{emailErrMsg}</p>
              )}
            </div>
            ...
            <div>
              ...
              {passwordErrMsg && (
                <p id="login-password-error" role="alert" className="mt-1.5 text-xs text-red-500">{passwordErrMsg}</p>
              )}
            </div>
