...
export default function PathExperience({
  ...
  return (
    <div>
      ...
      {flatSteps.length > 0 && (
        <div id="path-progress-card" className="sticky top-[calc(var(--ptec-sticky-top)+0.5rem)] z-20mb-6 rounded-2xl border border-divider bg-bg-surface/95 p-3.5 shadow-sm backdrop-blur max-lg:bg-bg-surface max-lg:backdrop-blur-none sm:p-4">
