...
// /journals/articles/[slug] error boundary. The state, the wording and the recovery actions are
...
export default function PublicationError(props: ErrorBoundaryProps) {
  return <ErrorRecovery {...props} subject="publication" logLabel="/journals/articles/[slug]" />;
}
