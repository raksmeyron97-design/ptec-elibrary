  ...
  return (
    <>
      ...
      <div className="mb-4 flex items-center gap-2">
        ...
        <span className="text-base font-semibold text-slate-700">Images</span>
      ...
      <div className="grid grid-cols-2 gap-2 sm:gap-3 md:grid-cols-4">
        {urls.map((url, i) => (
          <button
            ...
            className="group relative overflow-hidden rounded-lg bg-slate-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#007c91]"
      ...
      {lightboxIdx !== null && (
        ...
        >
          ...
          <button onClick={closeLightbox} aria-label="Close"
            className="absolute right-4 top-4 rounded-full bg-white/10 p-2.5 text-white backdrop-blur-sm transition hover:bg-white/25">
          ...
          {/* Counter */}
          {urls.length > 1 && (
            <span className="absolute bottom-4 left-1/2 -translate-x-1/2 rounded-full bg-white/10 px-4 py-1.5 text-sm font-medium text-white backdrop-blur-sm">
