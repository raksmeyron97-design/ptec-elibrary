...
// app/books/[slug]/error.tsx
// Shown when the book detail page throws (bad slug handled separately by notFound()).
...
export default function BookDetailError({
  ...
  useEffect(() => {
    console.error("[/books/[slug] error]", error);
  }, [error]);
  ...
  return (
    <section className="flex min-h-[60vh] flex-col items-center justify-center px-6 py-20 text-center">
      ...
      <h1 className="text-xl font-bold text-text-heading">Unable to load this book</h1>
      <p className="mt-2 max-w-sm text-sm text-text-muted">
        Something went wrong while fetching the book details. Please try again.
      </p>
