        ...
        <div className="relative overflow-hidden rounded-2xl bg-[#0a1629] p-8 text-white shadow-lg">
          ...
          <div className="relative flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap gap-3">
              {isAdmin && (
                <Link href="/admin"
                  className="inline-flex h-10 items-center gap-2 rounded-lg bg-amber-400 px-4 text-sm font-semibold text-slate-900 transition hover:bg-amber-300">
                  <Icon name="school" className="text-base" />Admin Panel
                </Link>
              )}
              <Link href="/books"
